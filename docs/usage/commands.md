...
- **Ctrl + Home / End** — Jump to top or bottom of the file.
...
- **Backspace / Delete** — Delete characters or selections.
- **Shift + Delete** — Delete from the cursor to the end of the line.
- **Ctrl + Z** — Undo the last action.
- **Ctrl + Shift + Delete** — Delete from the cursor to the end of the file.
- **Ctrl + M** — Insert a paragraph mark / indent marker.
...
- **Alt + N** — Replace current match and find next.
...
- **Ctrl + Shift + E** — Insert Page Break.
- **Ctrl + Shift + C** — Chain another print file.
...
- **Ctrl + Backslash** — Run a macro (`.BAS` file).
- **F5** — Run the current program (`.BAS`, `.ASM`, `.PRG`, `.PY`).
