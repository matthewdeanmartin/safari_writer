...
ASM_MODULE := safari_asm
READER_MODULE := safari_reader
ALL_MODULES := $(WRITER_MODULE) $(DOS_MODULE) $(CHAT_MODULE) $(FED_MODULE) $(ASM_MODULE) $(READER_MODULE)
PYTEST_COVERAGE_MODULES := $(WRITER_MODULE) $(DOS_MODULE) $(CHAT_MODULE) $(BASE_MODULE) $(FED_MODULE) $(ASM_MODULE) $(READER_MODULE)
