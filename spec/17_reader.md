...
1. **Dictionary Screen / Lookup Pop-up**
   Look up currently selected word.

1. **Bookmarks & Notes Screen**
   Jump points, highlights, notes.

1. **Preferences / Setup Screen**
...
1. App shows metadata/details.
1. User chooses format.
1. App downloads.
1. App imports into local library.
1. App offers “Read now?”
...
1. Choose title
1. Resume reading
1. Adjust text size and spacing
1. Bookmark passage
1. Quit; position auto-saved

## 18.2 Look up a word

1. While reading, move to word
1. Press `D`
1. Dictionary pop-up appears
1. Read definition
1. `Esc` returns to same reading position

## 18.3 Download a public-domain novel

1. Open Catalog
1. Browse Top Titles or Search
1. Select title
1. Review metadata
1. Download text/EPUB
1. Add to library
1. Start reading
...
1. Open Catalog
1. Select Categories
1. Choose Fiction / Science / History / etc.
1. Scroll titles
1. Download or inspect details
